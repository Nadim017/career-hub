  ...
  return (
    <div className=" flex justify-center items-center h-screen container mx-auto">
      <div>
        ...
        <h3 className="text-3xl font-semibold">b. What is a custom hook?</h3>
        <p className="mb-5 text-xl">
        ...
        <h3 className="text-3xl font-semibold">c. What is useRef?</h3>
        <p className="mb-5 text-xl">
        ...
        <h3 className="text-3xl font-semibold">d. What is useMemo?</h3>
        <p className="mb-5 text-xl">
